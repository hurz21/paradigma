...
Class Window1
    ...
    '            tbzuVorgang.Text = clsStartup.vorgangsvorschlag
    ' End Sub 
    '    Private Sub timereinrichten()
    '        'alle 5 sekunden nachschauen ob sich was an der vorgangsliste geändert hat
    '        Dim dispatcherTimer As System.Windows.Threading.DispatcherTimer
    '        dispatcherTimer = New System.Windows.Threading.DispatcherTimer()
    '        AddHandler dispatcherTimer.Tick, AddressOf dispatcherTimer_Tick
    '        'dispatcherTimer.Tick += new EventHandler(dispatcherTimer_Tick)
    '        dispatcherTimer.Interval = New TimeSpan(0, 0, 5) '5sekunden
