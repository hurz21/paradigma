...
Public Class winvcfTools
    ...
    Shared Sub trimmen(ByRef lines As String())
        For i = 0 To lines.GetUpperBound(0)
            lines(i) = clsString.noWhiteSpace(lines(i))
        Next
        For i = 0 To lines.GetUpperBound(0)
            lines(i) = Trim(lines(i))
        Next
    End Sub
    Public Shared Sub ZeilenZusammnenfuegen1(ByVal jfread As vCardReader, ByRef lines As String(), ByVal continueLinestring As String)
