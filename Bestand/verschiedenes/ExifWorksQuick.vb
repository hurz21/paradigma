...
#Region " Nicely formatted well-known properties "
    ...
    Public Property DateTimeLastModified() As DateTime
        ...
        Set(ByVal Value As DateTime)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick DateTimeLastModified:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property DateTimeOriginal() As DateTime
        ...
        Set(ByVal Value As DateTime)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick DateTimeOriginal:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property DateTimeDigitized() As DateTime
        ...
        Set(ByVal Value As DateTime)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick DateTimeDigitized:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property Title() As String
        ...
        Set(ByVal Value As String)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick Title:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property UserComment() As String
        ...
        Set(ByVal Value As String)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick UserComment:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property Artist() As String
        ...
        Set(ByVal Value As String)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick Artist:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property Description() As String
        ...
        Set(ByVal Value As String)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick Description:" & ex.ToString)
            End Try
        End Set
    End Property
    ...
    Public Property Copyright() As String
        ...
        Set(ByVal Value As String)
            ...
            Catch ex As Exception
                nachricht("Fehler in exifworksquick Copyright:" & ex.ToString)
            End Try
        End Set
    End Property
...
#Region " Support methods for working with EXIF properties "
    ...
    Public Function IsPropertyDefined(ByVal PID As Int32) As Boolean
        ...
        Catch ex As Exception
            MsgBox("IsPropertyDefined Fehler: " & ex.ToString)
            Return False
        End Try
