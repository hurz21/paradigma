...
#Region "RB_adresse"
    ...
    Public Shared Sub hole_AdressKoordinaten_bynames() 
        myGlobalz.sitzung.postgresREC.mydb.SQL = "select rechts,hoch from public.halofs " &  
    ...
    Public Shared Sub holeStrasseDTausHalo(buchstabe As String) 
        If String.IsNullOrEmpty(buchstabe) Then
            myGlobalz.sitzung.postgresREC.mydb.SQL = "select distinct strcode ,sname,'halo' from public.halofs " &  
                " where gemeindenr = " & myGlobalz.sitzung.aktADR.Gisadresse.gemeindeNrBig() & _
                " order by	sname asc"
        Else
            myGlobalz.sitzung.postgresREC.mydb.SQL = "select distinct strcode ,sname,'halo' from public.halofs " &  
    ...
    Public Shared Sub holeZaehlerDT()
        myGlobalz.sitzung.postgresREC.mydb.SQL = "select distinct zaehler from flurkarte.basis_f " & _
...
#End Region
    ...
    Shared Sub holeStrasseDTausLageschluessel(buchstabe As String)
        ...
        If String.IsNullOrEmpty(buchstabe) Then
            myGlobalz.sitzung.postgresREC.mydb.SQL = "select distinct schluesselGesamt as strcode,bezeichnung as sname,'lage' from  public.lageschluessel " &
                                  myGlobalz.sitzung.postgresREC.mydb.Tabelle & _
