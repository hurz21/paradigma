...
Public Class WinBearbeiterauswahl
    ...
    Private Sub WinBearbeiterauswahl_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        Dim sql As String = "select NAMENSZUSATZ,NACHNAME,VORNAME,ABTEILUNG,USERNAME,RANG,TELEFON,EMAIL,LOWER(INITIAL_) as ""INITIALE"",KUERZEL1,stdgrants   from Bearbeiter " &
    ...
    Private Sub chkaktiv_Click_1(sender As Object, e As RoutedEventArgs)
        ...
        If chkaktiv.IsChecked Then
            sql = "select NAMENSZUSATZ,NACHNAME,VORNAME,ABTEILUNG,USERNAME,RANG,TELEFON,EMAIL,LOWER(INITIAL_) as ""INITIALE"",stdgrants  from Bearbeiter " &
                  " where nachname<>'Gast' and aktiv=1 order by abteilung, NACHNAME asc"
            refreshListe(sql)
        Else
            sql = "select NAMENSZUSATZ,NACHNAME,VORNAME,ABTEILUNG,USERNAME,RANG,TELEFON,EMAIL,LOWER(INITIAL_) as ""INITIALE"",stdgrants from Bearbeiter " &
