...
Public Class winUserDetail
    ...
    Private Sub tbName_TextChangedExtracted()
        If modus = "neu" Then
            testid.Text = clsString.umlaut2ue(tbName.Text) & "_" & getVornameBuchstabe()
        End If
    End Sub
        ...
        If userPropSetzen(_testUser) Then
            ...
            If modus = "neu" Then
                Dim text As String = "Hinweis:" & Environment.NewLine &
                    ...
                    "           O:\UMWELT-PARADIGMA sehen kann" & Environment.NewLine &
                    "" & Environment.NewLine &
    ...
    Private Sub refreshADeintrag()
        ...
        Else
            Select Case JFactiveDirectory.umweltamt. istImUmweltamt(lokdt)
                Case -1
                    MsgBox("Der Bearbeiter " & filter & " ist nicht Teil des Umweltamtes. Daher hat er keine vollen Rechte. Wenn gewünscht bitte Email an IT, mit der Bitte um Zuweisung der Person an den FD Umwelt im ActiveDirectory.")
                Case 0
