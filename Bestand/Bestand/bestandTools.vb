...
Namespace bestandTools
    ...
    Public Class btnBestandtoExcel_ClickExtracted
        Public Shared Sub exe()
            Dim handcsv As New clsCSVausgaben("Vorgaenge", myGlobalz.sitzung.VorgangREC.dt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
