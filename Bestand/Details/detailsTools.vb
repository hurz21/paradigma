...
Public Class detailsTools
    ...
    Public Shared Sub EreignisExcel_ClickExtracted()
        Dim handcsv As New clsCSVausgaben("Ereignisse", myGlobalz.sitzung.EreignisseRec.dt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
    ...
    Public Shared Sub BeteiligteExcel_ClickExtracted()
        Dim handcsv As New clsCSVausgaben("Beteiligte", myGlobalz.sitzung.beteiligteREC.dt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
        nachricht(" exportfile:" & handcsv.CscDateiAusgeben())
        handcsv.start()
        handcsv.Dispose()
    End Sub
    ...
    Public Shared Sub DokumenteExcel_clickExtracted()
        Dim handcsv As New clsCSVausgaben("Dokumente", myGlobalz.Arc.vorgangDocDt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
        nachricht(" exportfile:" & handcsv.CscDateiAusgeben())
        handcsv.start()
        handcsv.Dispose()
    End Sub
    ...
    Public Shared Sub RaumbezugExcel_clickExtracted()
        Dim handcsv As New clsCSVausgaben("Raumbezuege", myGlobalz.sitzung.raumbezugsRec.dt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
        nachricht(" exportfile:" & handcsv.CscDateiAusgeben())
        handcsv.start()
        handcsv.Dispose()
    End Sub
    ...
    Shared Function erstelleCSVausgabeDerFlurstuecke(ByVal p1 As Integer) As Boolean
        Dim handcsv As New clsCSVausgaben("FlurstueckeFuerEigentuemer", myGlobalz.sitzung.raumbezugsRec.dt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
        nachricht(" exportfile:" & handcsv.CscDateiAusgeben())
        handcsv.Dispose()
    End Function
