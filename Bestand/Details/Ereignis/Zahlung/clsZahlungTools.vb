...
Namespace ZahlungToolsNs
    ...
    Public Class ExcelausgabeExtracted
        Public Shared Sub execute()
            ...
            Dim handcsv As New clsCSVausgaben("Zahlungen", myGlobalz.sitzung.tempREC.dt, myGlobalz.sitzung.aktVorgangsID,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
