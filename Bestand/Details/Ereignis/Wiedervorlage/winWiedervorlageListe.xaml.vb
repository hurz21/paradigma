...
Partial Public Class Window_Wiedervorlage
    ...
    Private Sub WVExcel_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs)
        e.Handled = True
        Dim handcsv As New clsCSVausgaben("Wiedervorlagen", myGlobalz.sitzung.DBWiedervorlageREC.dt, 0,"", CLstart.mycSimple.Paradigma_local_root, CLstart.mycSimple.enc)
