...
Public Class clsVorlagenTools
    ...
    Public Shared Function prepareSelectetedVorlageDokument(ByVal insarchiv As Boolean, _
                                ByVal dateiname As String, _
                                ByRef outfile As String, _
    ...
    Shared Function holePersonenliste(ByVal vid As Integer) As List(Of Person) 'myGlobalz.sitzung.VorgangsID
        ...
        Try
            ...
            Return loklist
        Catch ex As Exception
            nachricht("holePersonenliste: " & ex.ToString)
            Return Nothing
        End Try
    End Function
        ...
        Try
            ...
            If erfolg Then
                ...
                For i = 0 To myGlobalz.sitzung.raumbezugsRec.dt.Rows.Count - 1
                    ...
                    funktion$ = CStr(clsDBtools.fieldvalue(myGlobalz.sitzung.raumbezugsRec.dt.Rows(i).Item("TITEL"))).Trim
    ...
    Shared Function getGemarkungstextFromGEMKRZ(ByVal GEMKRZ As String) As String
        ...
        Try
            ...
            Return result
        Catch ex As Exception
            nachricht("Fehler in getGemarkungstextFromGEMKRZ: " & ex.ToString)
            Return ""
        End Try
    End Function
    ...
    Shared Function getGemeindetextFromGEMKRZ(ByVal GEMKRZ As String) As String
        ...
        Try
            ...
            Return result
        Catch ex As Exception
            nachricht("Fehler in getGemeindetextFromGEMKRZ: " & ex.ToString)
            Return ""
        End Try
    End Function
    ...
    Public Shared Sub berechneVorlagenverzeichnisAllgemein(ByRef di As IO.DirectoryInfo, ByVal modus As String, ByRef pfad As String)
    ...
    Public Shared Function presentVorlagenListe(ByRef ListeAllerVorlagenImVerz As List(Of IO.FileInfo),
        ...
        berechneVorlagenverzeichnisAllgemein(vorlagenVerzeichnis, modus, pfad)
        ...
        'FilterList.Add("*.docx")
        '  FilterList.Add("*.xls")
        Dim filterstring As String = "*.doc,*.xlsx,*.pdf" 'warum nicht xls?
        If modus = "_##permanent##_" Then
            filterstring = "*.doc,*.xlsx,*.pdf,*.mdb,*.mdb,*.accdb" '"*" & modus & "*.doc," & "*" & modus & "*.xlsx," & "*" & modus & "*.pdf"
        End If
