Public Class clsMailsenden
    ...
    Public Overloads Shared Function mailrausSMTP(ByVal von As String,
        ...
        Try
            ...
            End If
            '  von = userid
            mailserver = "10.34.102.254"
            Debug.Print(von)
            If String.IsNullOrEmpty("10.34.102.254") Then Return False
        ...
        Catch ex As Exception
            My.Log.WriteEntry("fehler in: mailrausSMTP " & ex.ToString)
            Return False
        End Try
    End Function
    ...
    Private Shared Function MailSenden(ByRef hinweis$, ByVal smtp As System.Net.Mail.SmtpClient, ByVal msg As System.Net.Mail.MailMessage) As Boolean
        ...
        Catch smt As Exception
            ...
            MsgBox(" smt-exception: fehler1$:" & hinweis)
            Return False
        End Try
    End Function
