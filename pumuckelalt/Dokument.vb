...
#End If
    ...
    '''	<returns></returns>
    '''	<remarks></remarks>
    Function makeFullname_Checkout(ByVal VorgangsID As Integer, ByVal lokalescacheverzeichnis As String, dokid As Integer) As String     'myGlobalz.Arc.lokalerCheckoutcache
