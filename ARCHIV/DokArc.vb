...
#End Region
    ...
    Public Function checkIN_FileArchiv(ByVal QuelleFullname As String, _
        ...
        Try
            ...
            Dim normname As String = clsString.normalize_Filename(Fquell.Name)
    ...
    Public Overloads Function DataTable_auschecken(ByVal zielVerzeichnis As String,
        ...
        For Each dok As DataRow In myGlobalz.Arc.ArcRec.dt.AsEnumerable
            Try
                ...
                My.Log.WriteEntry("a1") : Dim aktdo As New LIBArchiv.Dokument
    ...
    Public Shared Sub zulisteAddieren()
        Dim newdog As New LIBArchiv.Dokument
    ...
    Public Shared Function istInCheckoutListe(ByVal dok As LIBArchiv.Dokument, ByRef dieliste As List(Of Dokument)) As Boolean
    ...
    Public Shared Sub zuCheckoutlisteAddieren(ByVal dok As LIBArchiv.Dokument, ByRef dieliste As List(Of Dokument))
    ...
    Public Shared Sub ausCheckoutlisteEntfernen(ByVal dok As LIBArchiv.Dokument, ByRef dieliste As List(Of Dokument))
        If dok Is Nothing Then Exit Sub
        If dieliste Is Nothing Then Exit Sub
        If listeEnthaeltDokument(dok, dieliste) Then
            dieliste.Remove(dok)
            ...
            For i = 0 To myGlobalz.Arc.ArcRec.dt.Rows.Count - 1
                If myGlobalz.Arc.ArcRec.dt.Rows(i).Item("Typ").ToString.ToLower = "jpg" Then
                    ...
                    If Not dokulok.istVeraltet Or auchVeraltete Then
                        ...
                        dokulok.makeFullname_Checkout(VorgangsID%, myGlobalz.Arc.lokalerCheckoutcache)
    ...
    Public Shared Function listeEnthaeltDokument(ByVal dok As Dokument, ByVal dieliste As List(Of Dokument)) As Boolean
        For Each ddog As LIBArchiv.Dokument In dieliste
