Public Class checkout
    Private Shared Function bildeFIold(ByVal aktdoku As LIBArchiv.Dokument, ByRef fiold As IO.FileInfo) As String
        Try
    ...
    Private Shared Function ArchivDateinameGueltig(ByVal aktdoku As LIBArchiv.Dokument) As String
        ...
        Return String.Empty
    End Function
    Public Shared Function checkout(ByVal aktdoku As LIBArchiv.Dokument, ByVal lokvorgangsid As Integer) As String 'myGlobalz.sitzung.VorgangsID
        ...
        If aktdoku.FullnameCheckout.IsNothingOrEmpty Then
            myGlobalz.sitzung.aktDokument.makeFullname_Checkout(lokvorgangsid, myGlobalz.Arc.lokalerCheckoutcache)
        End If
    ...
    Private Shared Function rauskopieren(ByVal aktdoku As LIBArchiv.Dokument, ByVal nointeraction As Boolean, ByVal fiold As IO.FileInfo) As String
        ...
        Catch ex As Exception
            ...
            Else
                ...
                result = MessageBox.Show(String.Format("Diese Datei existiert schon: {0}{1} Ersetzen ?", 
                                 myGlobalz.sitzung.aktDokument.DateinameMitExtension, vbCrLf), _
