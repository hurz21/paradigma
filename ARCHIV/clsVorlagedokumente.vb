...
Public Class clsVorlagedokumente
    Public Shared _VorlageDateiImArchiv As IO.FileInfo
    ...
    Private Shared Sub vorlagendateiInsLokCheckoutDirKopieren(ByVal vdatei As String, ziel As String)
    ...
    Shared Function VorlageImArchivVerwendenXLSPDF(ByRef outdatei As String,
                                            ...
                                            ByVal ereignisart As String,
                                             ...
                                             ereignisid As Integer) As Boolean
        'neuenNamen bilden
        Dim neuername As String = neuenNamenVerwendenBilden(dateityp) '".doc")
        ...
        If dateityp = ".doc" Or dateityp = ".docx" Then
            _VorlageDateiImArchiv.CopyTo(myGlobalz.sitzung.aktDokument.FullnameCheckout)
        Else
            vorlagendateiInsLokCheckoutDirKopieren(vdatei, myGlobalz.sitzung.aktDokument.FullnameCheckout)
        End If
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Shared Function neuenNamenVerwendenBilden(ByVal endungMitPunkt As String) As String
        Try
