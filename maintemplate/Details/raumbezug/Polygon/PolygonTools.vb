...
Public Class PolygonTools
    ...
    Public Shared Function RB_ParaPolygon_holen(ByVal rid As Long) As Boolean 'myGlobalz.sitzung.aktPolygon.RaumbezugsID
        ...
        Try
            ...
            myGlobalz.sitzung.tempREC.mydb.SQL =
             "select typ,areaqm,serialshape,vorgangsid,id from " & CLstart.myViewsNTabs.tabRaumbezug2geopolygon & "   " &
    ...
    '    myGlobalz.sitzung.tempREC.mydb.SQL =
    '              "select * from " & CLstart.myViewsNTabs.tabRAUMBEZUG     & "  p, " & CLstart.myViewsNTabs.tabRaumbezug2geopolygon      & "    s " &
    '              " where p.typ=3" &
