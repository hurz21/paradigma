...
Namespace DokArcTools
    ...
    '        'End If
    '        If myGlobalz.ARC_MYDB.dbtyp = "oracle" Then
    '            Dim zzz As New clsEreignisDB_Oracle(clsDBspecOracle.getConnection(myGlobalz.ARC_MYDB))
    '            result = zzz.EntKoppelung_Dokument_Ereignis(Dokumentid%, EreignisID%)
    '            zzz.Dispose()
    '        End If
    '        Return result
    ...
    '        End If
    '        If myGlobalz.ARC_MYDB.dbtyp = "oracle" Then
    '            Dim zzz As New DBraumbezug_Oracle(clsDBspecOracle.getConnection(myGlobalz.ARC_MYDB))
    '            result = zzz.getID4Foto(Dokumentid%)
    '            zzz.Dispose
    '        End If
    '        Return result
