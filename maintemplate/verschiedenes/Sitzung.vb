...
Public Class Psession
    ...
    Public dbcrudwv As clsWiedervorlageDB_CRUD_MYSQL 'war vororacle NEW 
    ...
    '  Public checkoutDokuList As New List(Of Dokument)
    ''' <summary>
    ''' Die collection der in benutzung befindlichen dokumente
    ''' </summary>
    ''' <remarks></remarks>
    Private _checkoutDokuList As New List(Of Dokument)
    Public Property checkoutDokuList() As List(Of Dokument)
        Get
            Return _checkoutDokuList
        End Get
        Set(ByVal value As List(Of Dokument))
    ...
    'Shared Property w_detail As Window_Detail
    Shared Property presDokus As List(Of clsPresDokumente)
    Shared Property presFotos As List(Of clsPresDokumente)
