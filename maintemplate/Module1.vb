...
Module meineExtensionsIsnullorempty
    ...
    'Public Function getDT4Query(sql As String, ByVal myneREC As IDB_grundfunktionen) As DataTable
    '    'Dim dt As DataTable
    '    Try
    ...
    '            If myneREC.mydb.SQL.ToLower.Trim.StartsWith("delete") Or myneREC.mydb.SQL.ToLower.Trim.StartsWith("update") Then
    '                'dt darf leer sein
    '            Else
