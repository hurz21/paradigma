...
'    Shared Function wurdensDokumenteGeaendert(ByVal checkoutDokuList As List(Of Dokument),
...
'    Shared Function dokuschliessen(ByVal checkoutDokuList As List(Of Dokument),
'                                   ByVal dok As Dokument) As Boolean
...
'    Private Shared Function GetMesres(ByVal dok As Dokument) As MessageBoxResult
...
'    Private Shared Sub DateiLoeschenFallsExistiert(ByVal CO_test As IO.FileInfo, ByVal dok As Dokument)
'        Try
