...
Public Class clsVorlagenTools
    ...
    '    berechneVorlagenverzeichnis(vorlagenVerzeichnis, modus, pfad)
    ...
    '    'FilterList.Add("*.docx")
    '    '  FilterList.Add("*.xls")
    '    Dim filterstring As String = "*.doc,*.xlsx,*.pdf,*.docx" 'warum nicht xls?
    '    If modus = "_##permanent##_" Then
    '        filterstring = "*.docx,*.doc,*.xlsx,*.pdf,*.mdb,*.mdb,*.accdb" '"*" & modus & "*.doc," & "*" & modus & "*.xlsx," & "*" & modus & "*.pdf"
    '    End If
