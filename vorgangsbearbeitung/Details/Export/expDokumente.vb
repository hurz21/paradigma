...
'    Dim handcsv As New LIBcsvAusgabe.clsCSVausgaben("Dokumente", myGlobalz.Arc.vorgangDocDt,
...
'                        LIBgemeinsames.clsString.normalize_Filename(zeile.Item("BESCHREIBUNG").ToString, " "), limit).Replace(".", "").trim
