...
Public Class clsFlurstueck
	...
	Public Property gemarkungstext() As String
		...
		Set(ByVal value As String)
			...
			If _gemarkungstext.Trim.Length > 0 Then
				...
				End If
				gemarkungstextNORM = LIBgemeinsames.clsString.normalizeSuchdbStrasse(_gemarkungstext)
				If _gemeindeNr < 1 Or _gemeindeNr > 13 Then
					_gemarkungLiegtIMKreis = False
	...
	Public Sub New(ByVal neuFS$)
		...
		_grundbuchblattnr = ""
	End Sub
    Public Sub SetPartFromFS(ByVal lokFS As String)
    ...
    End Sub
    Public Function splitFS(ByVal lokFS As String) As Boolean
		Try
            SetPartFromFS(lokFS)
