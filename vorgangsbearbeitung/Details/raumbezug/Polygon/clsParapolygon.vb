...
Public Class clsParapolygon
    ...
    Public Sub gkstringausserial_generieren()
        ...
        If ShapeSerial IsNot Nothing Then
            Dim g As String = ShapeSerial.Replace("|", ";")
            GKstring = g.Substring(4, g.Length - 4)
        End If
    End Sub

    Public Function defineAbstract() As String
        abstract = LIBgemeinsames.clsString.Capitalize("Polygon ")
        If myGlobalz.sitzung.aktPolygon.Typ = RaumbezugsTyp.Polyline Then
            abstract = LIBgemeinsames.clsString.Capitalize("Polyline ")
        End If
        Return abstract
    End Function
    ...
    Public Function defineBboxfromGKstring(ByRef xmin As Double, ByRef xmax As Double, ByRef ymin As Double, ByRef ymax As Double) As Boolean
        ...
        Catch ex As Exception
            nachricht("Fehelr in defineBboxfromGKstring: " & ex.ToString)
            Return False
        End Try
    End Function
End Class
