...
Public Class detail_dokuauswahl
    ...
    '            dockument.makeFullname_Checkout(myglobalz.sitzung.aktVorgangsID, myglobalz.Arc.lokalerCheckoutcache, 0)
    ...
    '            dockument.makeFullname_Checkout(quellVid, myglobalz.Arc.lokalerCheckoutcache, 0)
    ...
    '        For Each dockument As clsPresDokumente In dlist
    '            If dockument.ausgewaehlt And (Not dockument.istNurVerwandt) Then
    '                dockument.makeFullname_Checkout(myGlobalz.sitzung.aktVorgangsID, myGlobalz.Arc.lokalerCheckoutcache, 0, ausgabeverzeichnis)
