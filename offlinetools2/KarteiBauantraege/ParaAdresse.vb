...
Public Class ParaAdresse
    ...
    Public Property RaumbezugsID() As Long Implements iRaumbezug.id
        ...
        End Set
    End Property
    Private _box As New LibGISmapgenerator.clsRange
    Public Property box() As libgismapgenerator.clsRange Implements iRaumbezug.box
        Get
            Return _box
        End Get
        Set(ByVal value As LibGISmapgenerator.clsRange)
            _box = value
    ...
    Public Property Name() As String Implements iRaumbezug.name 'wurde in der datenbank in TITEL umbenannt
        ...
        End Set
    End Property
    Private _punkt As New LibGISmapgenerator.myPoint
    Public Property punkt() As LibGISmapgenerator.myPoint Implements iRaumbezug.punkt
        Get
            Return _punkt
        End Get
        Set(ByVal value As LibGISmapgenerator.myPoint)
            _punkt = value
    ...
    Public Function defineAbstract() As String
        abstract = "" & PLZ & " " & LIBgemeinsames.clsString.Capitalize(Gisadresse.gemeindeName) & ", " & _
             Postfach & " " & _
