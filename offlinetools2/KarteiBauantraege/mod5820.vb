Module mod5820
    ...
    Public Sub stammobjekterzeugen()
        ...
        kartei.stamm.az.sachgebiet.Zahl = "5820"
        kartei.stamm.az.sachgebiet.Header = kartei.stamm.az.sachgebiet.Zahl & "-Lärmbeschwerden"
    ...
    Public Sub makebemerkung()
        kartei.stamm.Bemerkung = "Beschwerdeführer: " & p(6) & ", " & p(7) & ", " & p(8) & ", " & p(9) & " " & Environment.NewLine &
                                GetNachforderung() &
                                GetBeanstandung() &
                                GetBemerkung() &
                                GetOrtsbesichtigung() &
