...
Public Class clsGemarkungsParams
    ...
    Sub init()
        ...
        parms.Add(New clsGemarkungsParams With {.gemarkungstext = "Götzenhain", .gemeindetext = "Dreieich", .gemcode = 734, .gemeindenr = 2, .gemarkungskuerzel = "GÖ", .gemarkungsPLZ = "63303"})
    ...
    End Sub
    Public Function gemarkungstext2gemcode(ByVal gemarkungstext$) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemarkungstext2gemeindetext(ByVal gemarkungstext$) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemarkungstext2gemeindenr(ByVal gemarkungstext$) As String
        Dim result$ : init()
    ...
    Public Function gemcode2gemarkungstext(ByVal gemcode%) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemcode2gemarkungsplz(ByVal gemcode%) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemcode2gemeindetext(ByVal gemcode%) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemcode2gemeindenr(ByVal gemcode%) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemeindetext2gemeindenr(ByVal gemeindetext$) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemarkungsPLZ2gemeindetext(ByVal gemarkungsPLZ$) As String
        Dim result$ : init()
        ...
        Return result
    End Function
    Public Function gemeindenr2gemeindetext(ByVal gemeindenr$) As String
        Dim result$ : init()
    ...
    Public Function gemeindetext2PLZ(ByVal gemeindetext$) As Integer
        Dim result$ : init()
    ...
    Public Function nummer2gemeindename(ByVal nr$) As String
        Dim nri% = CInt(nr$)
        Try
            'ist des die PLZ?
        ...
        End Try
    End Function
    Public Shared Function liegtGemeindeImKreisOffenbach(ByVal Gemeindename$) As Boolean
        ' in: s$ gemeindename
        ...
        Try
            ...
            For i = 1 To 13
                'mylogmsg a(i)
                If LIBgemeinsames.clsString.normalizeGemeindenamen(Gemeindename$) = a(i) Then
                    Return True
                End If
            Next
            Return False
