...
Public Class Stamm
    ...
    Function createArchivsubdir(ByVal archivrootdir As String) As Boolean 'myGlobalz.Arc.rootDir.ToString
        Try
            Dim testdir As New IO.DirectoryInfo(archivrootdir$ & ArchivSubdir)
    ...
    Private _Standort As New AktenStandort
    Public Property Standort() As AktenStandort
        Get
            Return _Standort
        End Get
        Set(ByVal value As AktenStandort)
            _Standort = value
            OnPropertyChanged("Standort")
        End Set
    End Property
    ...
    '   Public dbcrudwv As New clsWiedervorlageDB_CRUD_MYSQL
    'Private _wiedervorlage As New clsWiedervorlage(dbcrudwv)
    'Public Property Wiedervorlage() As clsWiedervorlage
    '	Get
    ...
    Private _gutachten As New Gutachten
    Public Property meinGutachten() As Gutachten
        Get
            Return _gutachten
        End Get
        Set(ByVal value As Gutachten)
            _gutachten = value
            OnPropertyChanged("meinGutachten")
        End Set
    End Property
