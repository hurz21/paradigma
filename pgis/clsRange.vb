...
Public Class clsRange
    ...
    Public Function portrait() As Boolean
        ...
        End If
    End Function
    Public Function inside(ByVal mypoint As System.Drawing.Point) As Boolean
        'point inside range ?
        If mypoint.X > xl And
         mypoint.X < xh And
         mypoint.Y > yl And
    ...
    Public Function rangekopieren(ByVal quelle As clsRange, ByVal ziel As clsRange) As Boolean
        Try
