...
#Region "  Event Handlers  "
    ...
    Private Sub TextControl_Loaded(sender As Object, e As RoutedEventArgs)
        ...
        '5 = Titel
        If args.Length > 1 Then
            'm_fileHandler. = args(1)
            m_fileHandler.jfDateityp = ".docx"
            m_fileHandler.jfDokumentId = 1
            m_fileHandler.jfVorgangsid = 1 'args(4)
            m_fileHandler.jfVorgangsTitel = "titel" 'args(5)
            ...
            '    MsgBox("Die Datei ist schon geöffnet. Wir schließen diese Instanz wieder, sonst droht Datenverlust!")
