...
Public Class clsAufrufgenerator
    ...
    'Private Function combineHgrundVordergrund() As String
    '		 aktMap.layer=aktMap.Vordergrundebenen & ";" & aktMap.hgrund
    '	Return a$
    'End Function
    Public Property MapEngineAufruf As String = ""
    Function genaufrufWebgis() As String
        Try
            ...
            'Dim a$ = http://gis.kreis-of.local/cgi-bin/apps/gis/mapgenparadigma/mapgen.cgi?passwort=60d5a617024915e22902dc99c7fc446b &
    ...
    End Function
    <Obsolete>
    Function BildGenaufrufWebgis() As String 'BildGenaufrufMAPserver
        Try
            If keineEbenenGewaehlt(aktMap.Hgrund, aktMap.Vgrund) Then
                MsgBox("Es wurden keine Ebenen zur Darstellung gewählt. Daher wird die Kreisgrenze aktiviert.", MsgBoxStyle.Information, "Paradigma-GIS Schnittstelle")
                aktMap.Vgrund = "kreis;"
    ...
    Function ImapGenaufrufMAPserver(mapfile As String) As String
        Try
            ...
            Dim sb As New Text.StringBuilder
            sb.Append(Domainstring)
            sb.Append("/cgi-bin/mapserv64/mapserv.exe?" &
    ...
    End Function
    <Obsolete>
    Function BildGenaufrufMAPserver(mapfile As String) As String
        Try
            If keineEbenenGewaehlt(aktMap.Hgrund, aktMap.Vgrund) Then
                MsgBox("Es wurden keine Ebenen zur Darstellung gewählt. Daher wird die Kreisgrenze aktiviert.", MsgBoxStyle.Information, "Paradigma-GIS Schnittstelle")
                aktMap.Vgrund = "kreis;"
            ...
            Dim sb As New Text.StringBuilder
            sb.Append(Domainstring)
            sb.Append("/cgi-bin/mapserv64/mapserv.exe?mode=map&map=")
            sb.Append(mapfile)
            sb.Append("&mapsize=" & aktMap.aktcanvas.w & "+" & aktMap.aktcanvas.h)
    ...
    Public Shared Function WINPOINTVonCanvasNachGKumrechnen(ByVal aktpoint As myPoint, ByVal birdsrange As clsRange, ByVal Kreiscanvas As clsCanvas) As myPoint
        Try
            ...
            Dim neupoint As New myPoint() With {.X = testr, .Y = testh}
            Return neupoint
        Catch ex As Exception
            l("Fehler: ", ex)
            Return Nothing
