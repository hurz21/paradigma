...
Public Class clsPgsqlIns
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetNewid(ByRef com As NpgsqlCommand, ByVal SqlString As String) As Long
        Dim newid&
    ...
    Shared Sub nachricht(ByVal text$)
        My.Log.WriteEntry("IN oracleins1: " & text)
    End Sub
End Class
