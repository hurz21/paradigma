...
Public Class clsDBspecPostgres
    ...
    Protected Overrides Sub Finalize()
        ...
        Dispose(False)
    End Sub
    Public Function manipquerie(querie As String, slqparamlist As List(Of clsSqlparam), ReturnIdentity As Boolean,
        ...
        Try
            ...
            l("nach dboeffnen  ")
            com = New NpgsqlCommand(querie, myconn)
