Namespace LIBgemeinsames
    ...
    Public Class clsString
        ...
        Public Shared Function textEnthaelt(ByVal Text As String, ByVal Teil As String) As Boolean
        ...
        Shared Function istFoto(originalFullname As String) As Boolean
            Try
                ...
                test.Extension.ToLower = ".png" Then
                    test = Nothing
                    Return True
                Else
                    test = Nothing
            ...
            End Try
        End Function
        Public Shared Function getTextDelimiter(line As String) As String
            Dim textMarker As String = ""
            If line.Contains("'") Then textMarker = "'"
            If line.Contains(Chr(34)) Then textMarker = Chr(34)
            Return textMarker
        End Function
        Public Shared Sub leerzeichenRaus(ByRef result As String)
        ...
        Public Shared Function Capitalize(ByVal Alt As String) As String
            ...
            Return a & b
        End Function
        Public Shared Function CapitalizeKontakte(ByVal Alt As String) As String
            Try
                If Alt Is Nothing OrElse Alt.Length < 1 Then Return ""
                Dim a$ = Alt.Substring(0, 1).ToUpper
                Dim b$ = Alt.Substring(1, Alt.Length - 2)
                Dim c$ = Alt.Substring(Alt.Length - 1).ToUpper
                Return a & b & c
            Catch ex As Exception
                Return "?"
            End Try
        ...
        Public Shared Function isinarray(ByVal o As String,
                                     ByRef t As String,
                                     ByVal delim As String) As Boolean
...
ende:
        ...
        Public Shared Function getDateiEndung(quelldatei As String) As String
            Dim endung As String = ".docx"
            Dim fi As IO.FileInfo
            Try
                fi = New IO.FileInfo(quelldatei)
                endung = fi.Extension.ToLower
                Return endung
            Catch ex As Exception
                Return ".docx"
            End Try
...
#Region " Layerstring "
        ...
        Friend Shared Function ausduenner(temp As String) As String
            Try
                'l("ausduenner---------------------- anfang")
        ...
        Public Shared Function normalize_layerstring(ByVal ebenen_edukt As String, ByVal delim As Char) As String
            ...
            Try
                ...
                test_string = nodoubleStrings(ebenen_edukt, delim)
...
#End Region
        ...
        Public Shared Function changeHTML2text(ByRef s As String) As String
            Try
                ...
                Return s
            Catch e As Exception
                Dim messageValue = String.Format("Fehler:(changeUmlaut2Html): {0}<br>{1} {0}<br>{2} {0}<br>{3}<br> ",
             vbCrLf, e.Message, e.StackTrace, e.Source)
        ...
        Public Shared Function kuerzeTextauf(ByVal candidate As String, ByVal maxlen As Integer) As String
            Try
        ...
        Friend Shared Function ConvertListofString2ArrayOfString(dateien As List(Of String)) As String()
            Dim returnstr As String()
            Try
                If dateien Is Nothing OrElse dateien.Count < 1 Then Return returnstr
                ReDim returnstr(dateien.Count - 1)
                For i = 0 To dateien.Count - 1
                    returnstr(i) = dateien(i)
                Next
                Return returnstr
            Catch ex As Exception
                Return returnstr
