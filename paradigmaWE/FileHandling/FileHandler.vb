...
Namespace FileHandling
    ...
    Public Class FileHandler
        ...
        ' "C:\Users\" & Environment.UserName.ToLower & "\Desktop\Paradigma\locallocks"
...
#Region "  Public Methods  "
        ...
        Public Sub Open(Optional fileName As String = "", Optional bKeepPdfSecSettings As Boolean = False)
            ...
            Try
                ...
                Else
                    ...
                    'MsgBox("1 " & ext & ", " & fileName)
                    ext = jfDateityp
                    'MsgBox("1b " & ext & ", " & fileName)
                    Dim streamType As StreamType = ToTXStreamType(fileName)
                    '  streamType = StreamType.WordprocessingML 'ihah
                    'MsgBox(streamType.ToString)
        ...
        Public Sub Save()
            ...
            Dim saveSettings = New SaveSettings() With { _
				.CssFileName = Me.CssFileName, _
				.CssSaveMode = Me.CssSaveMode, _
				.UserPassword = Me.PDFUserPassword, _
				.MasterPassword = Me.PDFMasterPassword, _
				.DocumentAccessPermissions = Me.DocumentAccessPermissions, _
				.ReportingMergeBlockFormat = blockFormat _
			}
...
#End Region
    ...
    Module Extensions
        ...
        '    'MsgBox("ToTXStreamType " & fileExt)
        '    Select Case fileExt.ToLower.Trim()
        '        Case ".rtf"
