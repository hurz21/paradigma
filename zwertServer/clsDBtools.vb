...
Public Class clsDBtools
    ...
    'Public Shared Function UNION_SQL_erzeugenDokument(ByVal anyDT As DataTable,
    '                                            ByVal tabellenname$,
    '                                            ByVal ausgabespaltenNr%,
    '                                            ByVal idspalte$,
    '                                            ByVal ohneobsdoku As Boolean) As String
    '    Try
    '        Dim summe$ = "", andobs$ = ""
    '        If ohneobsdoku Then
    ...
    '    End Try
    'End Function
    'Public Shared Function UNION_SQL_erzeugenInns(ByVal anyDT As DataTable,
    '                                                    ByVal tabellenname$,
    '                                                    ByVal ausgabespaltenNr%,
    ...
    '            gesamt$ = "select * from " & tabellenname$ &
    ...
    '        Return gesamt$
    '    Catch ex As Exception
    '        nachricht("fehler in UNION_SQL_erzeugenDokument: " & ex.ToString)
    '        Return "-1"
    '    End Try
    'End Function
