Public Class adressToolsUI
    ...
    Public Shared Sub windRoseAnzeigen(ByVal x As Double, ByVal y As Double)
        ...
        Else
            ...
            MessageBox.Show("Sie können die Windrose als Dokument ins Paradigma übernehmen. " & vbCrLf &
                            "Dazu müssen Sie " & vbCrLf &
                            "1. die Windrose als PDF-Datei ausdrucken" & vbCrLf &
                            "2. die PDF-Datei abspeichern" & vbCrLf &
                            "3. die abgepeicherte Datei über den Reiter 'Dokumente' und " & vbCrLf &
                            "   dann den Knopf 'Hinzufügen' in den Vorgang integrieren.   ", "Empfehlung", MessageBoxButton.OK, MessageBoxImage.Information)
