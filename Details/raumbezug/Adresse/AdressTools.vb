...
Public Class AdressTools
    ...
    Shared Function adresseSchonInVorgangVorhanden(ByVal paraAdresse As ParaAdresse, ByVal vorgangsid As Integer) As Boolean
        ...
        Try
            myGlobalz.sitzung.tempREC.mydb.SQL =
                  "select * from paraadresse p , pa_sekid2vid s where gemeindenr=" & paraAdresse.Gisadresse.gemeindeNrBig &
    ...
    Public Sub buildStrassenListe(ByVal buchstabe As String, ByVal StrassenListe As List(Of strassenUiObj))
        ...
        For i = 0 To myGlobalz.sitzung.haloREC.dt.Rows.Count - 1
            ...
            strassseninstanz.sname = CStr(myGlobalz.sitzung.haloREC.dt.Rows(i).Item(1))
            strassseninstanz.strcode = CStr(myGlobalz.sitzung.haloREC.dt.Rows(i).Item(0))
            strassseninstanz.quelle = CStr(myGlobalz.sitzung.haloREC.dt.Rows(i).Item(2))
