Public Class clsMailsenden
    ...
    Public Overloads Shared Function mailrausSMTP(ByVal von$, _
     ByVal an$, _
     ByVal betreff$, _
     ByVal nachrichttext$, _
     ByVal anHang$, _
    ...
    Public Overloads Shared Function mailrausSMTP(ByVal von As String, _
                                                 ByVal an As String,
    ...
    Private Shared Function MailSenden(ByRef hinweis$, ByVal smtp As System.Net.Mail.SmtpClient, ByVal msg As System.Net.Mail.MailMessage) As Boolean
        ...
        Catch smt As Exception
            ...
            nachricht_und_Mbox(" smt-exception: fehler1$:" & hinweis)
            Return False
        End Try
    End Function
    Private Shared Sub anhang_handhaben(ByRef anHang$, ByVal msg As System.Net.Mail.MailMessage)
        Try
            ...
            End If
        Catch ex As Exception
            nachricht("Fehler bei anhang: " & vbCrLf & anHang & vbCrLf & ex.ToString)
        End Try
    End Sub
    Public Shared Function initEnvironment_MAILPARAMS(ByRef mailserver_internet$, ByRef mailserver_intranet$, _
     ByRef mailkonto_internet$, ByRef mailkonto_intranet$, _
     ByRef mailpw_internet$, ByRef mailpw_intranet$, _
    ...
    Shared Function mailrausOutlook(ByVal an$, ByVal betreff$, ByVal nachricht$, ByVal anHang$, ByVal CC$,
        ...
        Dim erfolg As String = LIBOutlook2.MeinOutlook.meinsendmail(an, betreff, nachricht, CC, "", anHang, anhangtrenner, outlookAnzeigen)
        Return erfolg
