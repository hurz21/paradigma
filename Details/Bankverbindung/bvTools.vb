...
Module bvTools
    ...
    Function bvNormalspeichernNEU(bv As clsBankverbindungSEPA) As Boolean
        If (myGlobalz.beteiligte_MYDB.dbtyp = "oracle") Then
            Dim zzz As New BvORACLE(LIBoracle.clsDBspecOracle.getConnection(myGlobalz.beteiligte_MYDB))
    ...
    Function getBankname(bname As String) As String
        If Not bname.IsNothingOrEmpty Then
            Return clsString.kuerzeTextauf(bname, 144)
        End If
        Return ""
    End Function
    ...
    Function getTitel(titel As String) As String
        If Not titel.IsNothingOrEmpty Then
            Return clsString.kuerzeTextauf(titel, 244)
        End If
        Return ""
    End Function
    ...
    Public Sub bvitem2Obj(item As DataRowView, aktbv As clsBankverbindungSEPA)
        Try
            With aktbv
                ...
                .istVORLAGE1 = CBool(clsDBtools.fieldvalue(item("VORLAGE1")))
    ...
    '            aktbv.istVORLAGE1 = CBool(clsDBtools.fieldvalue(.Rows(i).Item("VORLAGE1")))
    '        End With
    '    Catch ex As Exception
