...
#End Region
    ...
    Public Function kosten_loeschen(ByVal natID As Integer) As Integer
        Dim anzahlTreffer&
        Dim newid& = -1
        Try
            ...
            myGlobalz.sitzung.tempREC.mydb.Tabelle = "kosten"
    ...
    Public Function Kosten_abspeichern_EditExtracted(ByVal lnat As clsKosten) As Integer
        ...
        Try
            If lnat.id < 1 Then
                ...
                Return 0
            End If
            myGlobalz.sitzung.VorgangREC.mydb.Tabelle = "kosten"
