Public Class winAZdefineNEU
    ...
    Private Sub InitialComboFuerAdminSichtbarmachen()
        cmbUserInitial.Visibility = If(clsParadigmaRechte.istUser_admin_oder_vorzimmer(), Visibility.Visible, Visibility.Collapsed)
    End Sub
    ...
    Private Sub winAzdefine_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If modus.ToLower = "neu" Then
            tbBearbeiter.Text = myGlobalz.sitzung.aktBearbeiter.Kuerzel2Stellig
            _meinStamm.az.Prosa = ""
        ...
        If modus.ToLower = "edit" Then
            ...
            tbBearbeiter.Text = myGlobalz.sitzung.aktVorgang.Stammdaten.hauptBearbeiter.Kuerzel2Stellig
            getstamm67Text()
    ...
    Public Sub calcAzGesamt()
        ...
        End If
        tbAzgesamt.Text = tbstamm.Text & d$ & tbSachgebietZahl.Text & d$ & tbVorgangsID.Text & d$ & tbJahr.Text & d$ & tbBearbeiter.Text & prosa.Trim '& d$ & s
    ...
    Sub speichern()
        ...
        _meinStamm.hauptBearbeiter.Initiale = tbBearbeiter.Text
