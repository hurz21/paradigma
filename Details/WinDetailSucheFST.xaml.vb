...
Public Class WinDetailSucheFST
    ...
    Sub initFlureCombo()
        ...
        cmbFlur.DataContext = myGlobalz.sitzung.fstREC.dt
    End Sub
    ...
    Sub initZaehlerCombo()
        ...
        cmbZaehler.DataContext = myGlobalz.sitzung.fstREC.dt
    End Sub
    ...
    Private Sub cmbZaehler_SelectionChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.SelectionChangedEventArgs) Handles cmbZaehler.SelectionChanged
        ...
        initNennerCombo()
        If myGlobalz.sitzung.fstREC.dt.Rows.Count = 1 Then
            tbNenner.Text = myGlobalz.sitzung.fstREC.dt.Rows(0).Item(0).ToString
            NennerVerarbeiten()
    ...
    Sub initNennerCombo()
        ...
        cmbNenner.DataContext = myGlobalz.sitzung.fstREC.dt
    End Sub
