...
#Else
        l("vor paradigma" )
        With Paradigma_MYDB
            .Host = "msql01" ' CType(myglobalz.iniDict("VorgangDB.MySQLServer"), String)
            .Schema = "Paradigma" ' CType(myglobalz.iniDict("VorgangDB.Schema"), String)
            .Tabelle = "vorgang" ' CType(myglobalz.iniDict("VorgangDB.Tabelle"), String)
            .ServiceName = "paradigma.kreis-of.local" ' CType(myglobalz.iniDict("VorgangDB.ServiceName"), String)
            .username = "sgis" 'CType(myglobalz.iniDict("VorgangDB.username"), String)
            .password = "WinterErschranzt.74" ' CType(myglobalz.iniDict("VorgangDB.password"), String)
            .dbtyp = "sqls"  ' CType(myglobalz.iniDict("VorgangDB.dbtyp"), String)
        End With
        l("  Oracle_MYDB " & Paradigma_MYDB.tostring)
#End If
    ...
    Sub ini_WebgisREC()
        l("vor ini_WebgisREC ")
        With Webgis_MYDB
            .Host = "w2gis02" 'CType(iniDict("WebgisDB.MySQLServer"), String)
            .Schema = "webgiscontrol" ' CType(iniDict("WebgisDB.Schema"), String)
            .Tabelle = "nutzer" 'CType(iniDict("WebgisDB.Tabelle"), String)
            .ServiceName = "dummy" ' CType(iniDict("WebgisDB.ServiceName"), String)
            .username = "postgres" 'CType(iniDict("WebgisDB.username"), String)
            .password = "lkof4" 'CType(iniDict("WebgisDB.password"), String)
            .dbtyp = "postgres" 'CType(iniDict("WebgisDB.dbtyp"), String)
    ...
    End Sub
    Public Sub VerzeichnisseEinrichten(kartenebenenName As String, aid As Integer)
        l("VerzeichnisseErreichnen")
        KartenMapfileTemplate = myglobalz.gis_serverD & "/paradigmacache/vorlagen/raumbezug.map"
