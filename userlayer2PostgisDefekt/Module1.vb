...
#End If
        ...
        Dim result As String = modTools.main2(username, vid, modus, returnstring, DbTyp)
...
#End If
            ...
            .BaseFileName = "userlayer2postgis_" & username & "_" & modus & "_" & vid
            .AutoFlush = True
            .Append = False
        End With
        zeitStart = Now
