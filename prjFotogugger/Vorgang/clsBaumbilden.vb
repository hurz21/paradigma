Public Class clsBaumbilden
    ...
    Public Shared Function sucheStichwortInXML(ByVal xml_inifile_fullpath As String,
                                                ByVal stichwort As String,
                    ...
                    Case XmlNodeType.Element
                        If XMLReader.AttributeCount > 0 Then
                            ...
                            For i = 1 To CInt(XMLReader.Depth)
                                tabsumme &= vbTab
                            Next
                            If header.ToLower.Contains(stichwort) Or
    ...
    Public Shared Function AZistNeu() As Boolean
        ...
        myGlobalz.sitzung.VorgangREC.mydb.SQL = "select * from " & CLstart.myViewsNTabs.tabStammdaten & " where az2 = '" & azOhneUser3$ & "'"
    ...
    Public Shared Function sucheSGNRInXML_erweitert(ByVal xml_inifile_fullpath As String,
                ...
                Select Case XMLReader.NodeType
                    Case XmlNodeType.Element
                        ...
                        If XMLReader.AttributeCount > 0 Then
                            ...
                            Next
                            Try
                                If tiefetag IsNot Nothing Then
                                    If (tiefetag(2) IsNot Nothing) And (tiefetag(3) IsNot Nothing) Then
        ...
        Return ""
    End Function
    Public Shared Function sucheSGNRInXML(ByVal xml_inifile_fullpath As String,
