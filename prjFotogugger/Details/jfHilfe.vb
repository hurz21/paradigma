Module jfHilfe
    ...
    Private Function getLinkRoot(ByRef recs As String()) As String
        ...
        Catch ex As Exception
            nachricht("Keine Root Url gefunden, Fehler in getLinkRoot " ,ex)
            Return "Keine Root Url gefunden"
        End Try
    End Function
    ...
    '    Dim anker As String = sucheHtmlAnker(form_position, recs)
    ...
    Private Function sucheHtmlAnker(ByVal form_position As String, ByVal recs As String()) As String
