...
Module expBeteiligte
    ...
    Sub BETEILIGTE_CsvListeErstellen(datei As String)
        Dim handcsv As New LIBcsvAusgabe.clsCSVausgaben("Beteiligte", myGlobalz.sitzung.beteiligteREC.dt,
    ...
    Private Function GetDateinameBeteiligte(pfad_beteiligte As String, zeile As DataRow, endung As String) As String
        ...
        dateiname = dateiname & trennerInFileNames & LIBgemeinsames.clsString.normalize_Filename(zeile.Item("ROLLE").ToString)
        dateiname = dateiname & trennerInFileNames & LIBgemeinsames.clsString.normalize_Filename(zeile.Item("NACHNAME").ToString)
        dateiname = dateiname & trennerInFileNames & LIBgemeinsames.clsString.normalize_Filename(zeile.Item("VORNAME").ToString)
        dateiname = dateiname & trennerInFileNames & LIBgemeinsames.clsString.normalize_Filename(zeile.Item("ORGNAME").ToString)
