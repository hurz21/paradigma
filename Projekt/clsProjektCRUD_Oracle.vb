...
Public Class clsProjektCRUD_Oracle
    ...
    Public Function Projekt_abspeichern_Neu() As Integer
        ...
        Try
            ...
            Dim SQLUPDATE$ = _
         String.Format("INSERT INTO {0} (KATEGORIE1,KATEGORIE2,BEZEICHNUNGKURZ,BEZEICHNUNGLAN,VONDATUM,BISDATUM,QUELLE,GEMEINDE,WIEDERVORLAGEID) " +
                               " VALUES (:KATEGORIE1,:KATEGORIE2,:BEZEICHNUNGKURZ,:BEZEICHNUNGLAN,:VONDATUM,:BISDATUM,:QUELLE,:GEMEINDE,:WIEDERVORLAGEID)",
