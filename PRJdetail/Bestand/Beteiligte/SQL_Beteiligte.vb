Public Class SQL_Beteiligte
    ...
    Private Shared Function GetAnfang$()
        Dim anfang$ = "select distinct  s.VorgangsID, s.Ortstermin,s.Stellungnahme, v.AZ, s.Beschreibung,s.az2," + _
                 " s.LetzteBearbeitung,s.LastActionHeroe, s.Eingang ,b.anrede,b.NACHNAME as NACHNAME,b.Vorname,b.Gemeindename, b.Strasse,b.FFemail" & _
