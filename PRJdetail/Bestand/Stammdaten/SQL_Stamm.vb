Namespace Paradigma_bestandssuche
    ...
    Public Class SQL_Stamm
        ...
        Public Sub compozeStamm(ByVal rownum As String, zusatzSuche As String)
            ...
            Try
                ...
                If zusatzSuche = "ereignis" Then
                    ...
                    ereignisSuchen = True
                End If
                Dim anfang As String = GetAnfang()
                ...
                Dim datumsString As String = GetDatumsString()
        ...
        '    If beteiligtenSuchen Then
        '        anfang = " select v.*,b.vorgangsid FROM vsk_d v, beteiligte b where v.vorgangsid>0 "
        '    Else
        '        anfang = "select * FROM vsk_d v where vorgangsid>0 "
        '    End If
        '    Return anfang
        'End Function
        Private Function GetAnfang() As String
            ...
            Else
                ereignis = " "
            End If
            anfang = " select distinct v.vorgangsid FROM vsk_d v" & beteiligte & ereignis & " where v.vorgangsid>0 "
            Return anfang
        End Function
        ...
        Private Function GetFilterstring() As String
            ...
            If mittextfilter Then
                Dim ft As String = String.Format(" like '%{0}%' ", tbFilter_Text.ToLower)
                If bestandTools.verschiedenes.mitZusatzSuche(beteiligtenSuchen, ereignisSuchen) Then
                    ...
                    End If
                Else
                    Filterstring = String.Format(" and (lower(v.beschreibung) {0} or lower(v.VorgangsGegenstand){0} or lower(AZ){0} " &
