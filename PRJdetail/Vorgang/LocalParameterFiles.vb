...
Public Class LocalParameterFiles
    Shared Function parameterEinlesen(ByRef header As String,
        ...
        Try
            ...
            testdatei = Nothing
        Catch ex As Exception
            nachricht("Fehler in parameterEinlesen: " ,ex)
            Return ""
        Finally
    ...
    Public Shared Sub erzeugeParameterDateiAktvorgang_txt(ByVal verbose As Boolean,
                                                          ByVal mitgisdarstellung As Boolean)
        Dim zahl As String
        Try
            ...
            End Using
        Catch ex As Exception
            nachricht("Fehler in erzeugeParameterDatei, vermutlich eine zweite instanz von detail geöffnet: ", ex)
        Finally
