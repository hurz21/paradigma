...
Public Class WindetailNEU
    ...
    Private Sub gastLayout()
        ...
        'dgVorgangDokumente.Background = Brushes.White
    End Sub
...
", Angelegt: " & myglobalz.sitzung.aktVorgang.Stammdaten.Aufnahmedatum)
    ...
    Private Async Sub refreshDokumente(ByVal VorgangsID As Integer)
        ...
        Try
            Dim task As System.Threading.Tasks.Task(Of Boolean) = DokArcTools.dokusVonVorgangHolen.executeAsync(CStr(VorgangsID), "keinefotos", alleBilder:=True, 0)
    ...
    Private Function read_nurEinBildschirm() As Boolean
        ...
        End Try
    End Function
    Private Sub Windetail_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        e.Handled = True
        ...
        End If
        IO.Directory.SetCurrentDirectory("C:\kreisoffenbach\paradigmadetail")
    ...
    Private Sub initStartPositionOnScreen()
        ...
        Else
            Me.Top = topval
        End If
        Me.Left = CLstart.formposition.getPosition("diverse", "windetailformpositionleft", Me.Left)
        Me.Width = CLstart.formposition.getPosition("diverse", "windetailformpositionwidth", Me.ActualWidth)
        Me.Height = CLstart.formposition.getPosition("diverse", "windetailformpositionheight", Me.ActualHeight)
    End Sub
    ...
    Private Sub savePosition()
        ...
        Try
            ...
            CLstart.myc.userIniProfile.WertSchreiben("diverse", "windetailformpositionwidth", CType(Me.ActualWidth, String))
            CLstart.myc.userIniProfile.WertSchreiben("diverse", "windetailformpositionheight", CType(Me.ActualHeight, String))
        Catch ex As Exception
    ...
    Private Sub btnfotogugger2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs)
        ...
        If Psession.presFotos.Count < 1 Then
    ...
    Private Sub btnfotoguggerVerwandte_Click(sender As Object, e As RoutedEventArgs)
        e.Handled = True
    ...
    Private Shared Async Sub verwFotosAnzeigen()
        ...
        Dim task As System.Threading.Tasks.Task(Of Boolean) = DokArcTools.dokusVonVorgangHolen.executeAsync(CStr(verwandteVorgaengeSumme), "nurfotos", alleBilder:=True, 0)
        Dim bresult As Boolean = Await task
        ...
        Else
            MessageBox.Show("Die verwandten Vorgänge enthalten keine Fotos!!! Abbruch")
        End If

    End Sub

    Private Sub btnZuProbauG_Click(sender As Object, e As RoutedEventArgs)
        e.Handled = True
        detailsTools.starteProbaugView()
    End Sub

    Private Sub tbProbaugAZ_TextChanged(sender As Object, e As TextChangedEventArgs) Handles tbProbaugAZ.TextChanged
