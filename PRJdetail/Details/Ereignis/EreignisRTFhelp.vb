...
Class EreignisRTFhelp
    ...
    Shared Sub RTFdateispeichern(rtftext As String, zielvorgangsid As Integer, ByVal ArchivSubdir As String, kompress As Boolean)
        ...
        Dim loknewsavemode As Boolean = False
        ...
        If EreignisRTFhelp.lokaleDateiErzeugenOk(OriginalFullname, rtftext) Then
            ...
            Dim dokumentPfad As String = dokk.checkIN_FileArchiv(OriginalFullname, archivDateiFullname, erfolgreich,
                                              NumDir, ArchivSubdir, loknewsavemode, 0, kompress)
            ...
            Else
                MsgBox("Fehler beim Kopieren der Datei ins Archiv!!!" & Environment.NewLine &
                        ...
                        "" & Environment.NewLine)
                nachricht("Fehler beim Kopieren der Datei ins Archiv (rtf)!!!" & Environment.NewLine &
                       "Serverplatte voll ?" & Environment.NewLine &
                       "" & Environment.NewLine)
            End If
            dokk.Dispose()
    ...
    Private Shared Function lokaleDateiErzeugenOk(OriginalFullname As String, rtftext As String) As Boolean
        ...
        Catch ex As Exception
            nachricht("Fehler in lokaleDateiErzeugenOk:   :" ,ex)
            Return False
        End Try
    End Function
    ...
    Public Shared Function NotizRtfInhaltLadenExtracted(ByVal dokumentpfad As String) As String
        ...
        Try
            ...
            Return rtftext
        Catch ex As Exception
            nachricht("Fehler in NotizRtfInhaltLadenExtracted:   :" ,ex)
            Return ""
        End Try
    End Function
    ...
    Private Shared Sub AlteVersionLoeschen()
        ...
        Try
            ...
            testfile = Nothing
        Catch ex As Exception
            nachricht("Fehler in ereignisrtf  AlteVersionLoeschen:   :" ,ex)
