Public Class WinWordVorlageSteuerung
    ...
    Private Sub WinVorlageSteuerung_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Debug.Print("" & myGlobalz.sitzung.aktBearbeiter.defaultKontakt.elektr.Email)
        Debug.Print(myGlobalz.sitzung.aktVorgang.Stammdaten.hauptBearbeiter.Kontakt.elektr.Telefon1)
    ...
    Private Sub VorlagenStartroutine()
        Try
            ...
            End If
            tbSchlagworte.Text = schlagworteAusDateinamenbilden(quelldatei)
            Debug.Print("" & myGlobalz.sitzung.aktBearbeiter.defaultKontakt.elektr.Email)
    ...
    Private Function schlagworteAusDateinamenbilden(quelldatei As String) As String
