Public Class clsGooglecoordPrep
    Shared Function getgooglecoordinatenMitUmrechnung(ByVal adresse As String,
                                                        ByRef googlepunkt As clsGEOPoint,
                                                        ByVal ProxyString$,
                                                        ByRef hinweis$,
        ...
        Try
            ...
            l("getgooglecoordinatenMitUmrechnung " & adresse)
    ...
    Shared Function getgooglecoordinaten(ByVal adresse As String,
        ...
        Try
            ...
            If gd Is Nothing Then
                ...
                googlefehlertext = "Fehler: 1 Google liefert im Moment keine Koordinaten aus. Probieren Sie es später nochmal." ' & result$ 
            Else
            ...
            Return True
        Catch ex As Exception
            nachricht("fehler in getgooglecoordinaten: gd ist kein objekt iz " & iz & "  adresse: " & adresse & " " & Environment.NewLine ,ex)
            googlefehlertext = "Fehler: 2 Google liefert im Moment keine Koordinaten aus. Probieren Sie es später nochmal."
            Return False
        End Try
    End Function
...
#Enable Warning BC42030 ' Variable 'hinweis' is passed by reference before it has been assigned a value. A null reference exception could result at runtime.
            ...
            End If
        Catch ex As Exception
            nachricht("Fehler in getgooglecoordinatenUmrechnung: " & vbCrLf ,ex)
            Return False
        End Try
    End Function
