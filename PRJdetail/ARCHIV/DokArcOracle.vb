...
Public Class DokArcOracle
    ...
    Shared Sub bildesqlStringFuerdokumente(modus As String)
        If modus = "keinefotos" Then
            If Not String.IsNullOrEmpty(myGlobalz.Arc.ArcRec.mydb.SQL) Then
                myGlobalz.Arc.ArcRec.mydb.SQL = myGlobalz.Arc.ArcRec.mydb.SQL &
        ...
        If modus = "nurfotos" Then
            If Not String.IsNullOrEmpty(myGlobalz.Arc.ArcRec.mydb.SQL) Then
                ...
                myGlobalz.Arc.ArcRec.mydb.SQL = myGlobalz.Arc.ArcRec.mydb.SQL & " order by filedatum desc, exifdatum desc "

            End If
        Else
            If Not myGlobalz.Arc.ArcRec.mydb.SQL.ToUpper.Contains("EREIGNIS2DOK2") Then
                If Not myGlobalz.Arc.ArcRec.mydb.SQL.ToLower.Contains(" order ") Then
    ...
    Public Shared Function initDokumente4EreignisDatatable(ByVal ereignisid As Integer, ByVal modus As String) As Boolean
        ...
        bildesqlStringFuerdokumente(modus) : Dim hinweis As String = ""
    ...
    Public Shared Function initDokumente4VorgangDatatable(ByVal strVorgangsID As String, ByVal modus As String, allebilder As Boolean, eid As Integer) As Boolean
        myGlobalz.Arc.ArcRec.mydb.Host = myGlobalz.sitzung.VorgangREC.mydb.Host
        myGlobalz.Arc.ArcRec.mydb.Schema = myGlobalz.sitzung.VorgangREC.mydb.Schema
        ' myGlobalz.Arc.ArcRec.mydb.Tabelle ="dok2vid"
        'myGlobalz.Arc.ArcRec.mydb.Tabelle ="dokumente"
