    ...
    Private Shared Sub TM_AnredeAktPerson(ByRef replaceWordDict As Dictionary(Of String, String), documentbookmarks As List(Of String))
        Try
            ...
            If anrede.ToLower.Trim = "eheleute" Then
                ...
                Exit Sub
            End If
            If anrede.ToLower.Trim = "Frau und Herrn" Then
                replaceWordDict.Add("Anrede", "Frau und Herrn")
                replaceWordDict.Add("Anrede1", "geehrte/r")
                replaceWordDict.Add("Anrede2", "Frau und Herrn")
                laufendenNRInTextMarkenListe(replaceWordDict, "Frau und Herrn", "Anrede", documentbookmarks)
                Exit Sub
            End If
