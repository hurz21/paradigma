...
#Enable Warning BC42358 ' Because this call is not awaited, execution of the current method continues before the call is completed. Consider applying the Await operator to the result of the call.
    ...
    Shared Function AlleDokumentenKopieren(ByVal quellVorgangsID As Integer, ByVal ZielvorgangsIdInput As Integer, doppelteDokusAuchKopieren As Boolean) As String
        'alledokus auflisten
        Dim bresult As Boolean = DokArcTools.dokusVonVorgangHolen.execute(CStr(quellVorgangsID), "beides") ' nach myGlobalz.Arc.ArcRec
        Dim kopiert = 0
...
#Enable Warning BC42358 ' Because this call is not awaited, execution of the current method continues before the call is completed. Consider applying the Await operator to the result of the call.
    ...
    Public Shared Sub editDokumentMetadata()
        ...
        metadoku.ShowDialog()
    End Sub
    Public Shared Function Archiv_aktiviere_Dokument(dokumenteRitemousekeypressed As Boolean, readOnlyDoxsInTxtCrtlOeffnen As Boolean, aktThumbnailNotiz As String) As Boolean
        Dim box As WINBox
        ...
        If box.knopfnummer = 1 Then
            ...
            If DokArc.machCheckout(lfehler) Then
                ...
                DokArc.Archiv_aktiviere_dokument(myGlobalz.sitzung.aktDokument, readOnlyDoxsInTxtCrtlOeffnen)
        ...
        If box.knopfnummer = 14 Then
            ...
            Else
                If DokArc.machCheckout(lfehler) Then
                    DokArc.Archiv_aktiviere_dokument(myGlobalz.sitzung.aktDokument, CBool(box.readOnlyDoxsInTxtCrtlOeffnenLOKAL))
                Else
                    box.dokumentWurdeGeoeffnet = False
                    Return False
                End If
