...
Namespace DokArcTools
    ...
    Public Class dokusVonVorgangHolen
        Shared Function execute(ByVal strVorgangsID As String, ByVal modus As String) As Boolean 'myGlobalz.Arc.ArcRec
            Return exekern(strVorgangsID, modus)
        End Function
        Shared Async Function executeAsync(ByVal strVorgangsID As String, ByVal modus As String) As System.Threading.Tasks.Task(Of Boolean) 'myGlobalz.Arc.ArcRec
            Return exekern(strVorgangsID, modus)
        End Function

        Private Shared Function exekern(strVorgangsID As String, modus As String) As Boolean
            Return DokArcOracle.initDokumente4VorgangDatatable(strVorgangsID, modus)
        End Function
    End Class
