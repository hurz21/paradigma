...
Public Class PolygonTools
    ...
    Public Shared Function RB_ParaPolygon_holen(ByVal rid As Long) As Boolean 'myGlobalz.sitzung.aktPolygon.RaumbezugsID
        ...
        Try
            ...
            myGlobalz.sitzung.tempREC.mydb.SQL =
             "select typ,areaqm,serialshape,vorgangsid,id from " & CLstart.myViewsNTabs.tabRaumbezug2geopolygon & "    where raumbezugsid=" & rid
    ...
    Shared Sub polygonSeriallSpeichernImHintergrund(ByVal vid As Integer, ByVal rbid As Integer, ByVal rbtyp As Integer,
        ...
        querie = "INSERT INTO " & CLstart.myViewsNTabs.tabRaumbezug2geopolygon & "    (RAUMBEZUGSID,VORGANGSID,TYP,AREAQM,SERIALSHAPE) " +
                        " VALUES (@RAUMBEZUGSID,@VORGANGSID,@TYP,@AREAQM,@SERIALSHAPE)"

        clsSqlparam.paramListe.Add(New clsSqlparam("RAUMBEZUGSID", rbid))
        clsSqlparam.paramListe.Add(New clsSqlparam("VORGANGSID", vid))
        clsSqlparam.paramListe.Add(New clsSqlparam("SERIALSHAPE", serialstring))
        clsSqlparam.paramListe.Add(New clsSqlparam("TYP", rbtyp))
        clsSqlparam.paramListe.Add(New clsSqlparam("AREAQM", Flaecheqm))
    ...
    '    myGlobalz.sitzung.tempREC.mydb.SQL =
    '              "select * from raumbezug p, " & CLstart.myViewsNTabs.tabRaumbezug2geopolygon      & "    s " &
    '              " where p.typ=3" &
