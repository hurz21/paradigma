...
Public Class clsDBspecOracle
    ...
    Shared Sub nachricht(ByVal text$)
        My.Application.Log.WriteEntry("IN oracle: " & text)
    End Sub
    ...
    Public Function dboeffnen(ByRef resultstring As String) As Integer Implements IDB_grundfunktionen.dboeffnen
        ...
        Catch myerror As OracleException
            hinweis$ &= "OracleException, beim ÖFFNEN UU. ist die DB nicht aktiv. " & vbCrLf & "Fehler beim Öffnen der DB " & _
    ...
    Public Function getDataDT() As String Implements IDB_grundfunktionen.getDataDT
        ...
        Catch myerror As OracleException
            retcode = -1
            hinweis &= "FEHLER, getDataDT Database connection OracleException: " & _
             myerror.Message & " " & _
             myerror.Source & " " & _
             myerror.StackTrace & " " & _
    ...
    Private Shared Function getOracleconnectionString(mydb As clsDatenbankZugriff) As String

        Return "Data Source=(DESCRIPTION=" & _
             "(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=ora-clu-vip-003)(PORT=1521)))" & _
              "(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=ora-clu-vip-004)(PORT=1521)))" & _
             "(LOAD_BALANCE=yes) (CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=" & mydb.ServiceName & ")));" & _
