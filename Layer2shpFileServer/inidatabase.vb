...
Public Class inidatabase
    ...
    Shared Sub ini_WebgisREC()
        With Webgis_MYDB
            ...
            myGlobalz.webgisREC = CType(setDbRecTyp(Webgis_MYDB), LIBDB.IDB_grundfunktionen)
    ...
    Shared Sub ini_haloREC()
        ...
        l(halo_MYDB.Schema)
        l(halo_MYDB.Tabelle)
        l(halo_MYDB.username)
        l(halo_MYDB.password)
        l(halo_MYDB.dbtyp)
        With halo_MYDB
    ...
    Public Shared Function setDbRecTyp(ByVal dummyDB As clsDatenbankZugriff) As IDB_grundfunktionen
        ...
        Try
            If dummyDB.dbtyp = "oracle" Then
                dummREC = CType(New LIBoracle.clsDBspecOracle, IDB_grundfunktionen)
            End If
            If dummyDB.dbtyp = "mysql" Then
                dummREC = CType(New clsDBspecMYSQL, IDB_grundfunktionen)
            End If
