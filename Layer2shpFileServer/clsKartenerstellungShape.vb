...
Public Class clsKartenerstellungShape
    ...
    Function genKartenObjektePolygon(ByVal vorgangsid As Integer,
                                        ...
                                        paradigmaRBtyp As LibGISmapgenerator.RaumbezugsTyp) As String
        'boundingbox fixen
        Dim hinweis$ = ""
    ...
    Public Function webgisPreparieren(ByVal mitetikett As Boolean, username As String) As String
        ...
        LibGISmapgenerator.tools.makeMapFile(KartenMapfileTemplate, KartenMAPfile, KartenEbenenName, mitetikett, myGlobalz.enc, username)
    ...
    Private Shared Sub Raumbezug2Pointshp(ByVal vid%,
        ...
        Try
            ...
            For irec = 0 + ishp To rbTable.Rows.Count - 1 + ishp
                ...
                dateititel$ = CStr(LIBDB.clsDBtools.fieldvalue(rbTable.Rows(CInt(irec)).Item("titel")))
    ...
    Shared Function Spaltenwerte_Setzen(ByRef result As Boolean,
        ...
        result = sf.EditCellValue(0, ishp,
                                  String.Format("{0} / {1}{2}",
                                                         ...
                                                         CStr(LIBDB.clsDBtools.fieldvalue(rbTable.Rows(CInt(irec)).Item("titel"))), irec)) 'insert some string value
    ...
    Public Function polygon_shpfile_erzeugen(ByRef aktBox As clsRange, ByVal ebenen() As Integer, paradigmaRBtyp As LibGISmapgenerator.RaumbezugsTyp) As String
        Dim f As New MapWinGIS.Field
        Dim shape As New MapWinGIS.Shape
        Dim ishp% = 0
        Dim pt As New MapWinGIS.Point()
        ...
        Dim hinweis$
        Dim sf As New MapWinGIS.Shapefile
        glob2.nachricht("in polygon_shpfile_erzeugen")
    ...
    Private Shared Sub Raumbezug2Polygonshp(ByVal vid As Integer,
        ...
        Try
            ...
            For irec = 0 + ishp To rbTable.Rows.Count - 1 + ishp
                ...
                If SuchParadigmaRBtyp = RaumbezugsTyp.Flurstueck Then
                    If gefundenerRBTyp <> RaumbezugsTyp.Polygon And gefundenerRBTyp <> RaumbezugsTyp.Flurstueck Then
                        Continue For
                    End If

                End If
                If SuchParadigmaRBtyp = RaumbezugsTyp.Polyline Then
                    If gefundenerRBTyp <> RaumbezugsTyp.Polyline Then
                        Continue For
                    End If
                End If
                ...
                If SuchParadigmaRBtyp = RaumbezugsTyp.Polyline Then
                    ...
                    End If
                End If
                glob2.nachricht("ok es sit polygon und polygon wurde gesucht")
                If serial.StartsWith("POLYGON") Then
                    serial = modpostgis.wkt2serial(serial)
                End If

                If erfolgreich And Not serial.IsNothingOrEmpty Then
